...
# multivariate ols ### from Matteo: we can't fit an OLS in this case, unless you fit it to extract and analyze the residuals for EDA. 
                   ### OLS assumes independent residuals and homoskedasticity, GLS doesn't. 
m_ols <- lm(
  form_multivar,
  data = dat
)
